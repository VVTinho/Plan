        ...
        <ul id="menu" class="menu" title="">
            ...
            <li>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="#"><div id="objektnamnkommentar" title=""></div></a>
                                <ul>
                                    <form method="post" action="" id="commentsensor">
                                        <textarea name="comments" cols="25" rows="5" id="textareacomment">
                                        Skriv in din kommentar...
                                        </textarea>
                                        <br>
                                        <button type="submit" value="Submit" id="sub">Spara</button>
                                    </form>
                                </ul>
                            </li>
                        </ul>
            ...
            <li>
                ...
                <ul>
                    <li>
                        <a href="#">
                            <span id="statuslarm" title="">Alla Plan</span>
                        </a>
                        <ul id="chan"></ul>
                    </li>
                </ul>
